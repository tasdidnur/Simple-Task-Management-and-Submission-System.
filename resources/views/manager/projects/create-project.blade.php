...
<div class="card height-auto">
    <div class="card-body">
        <form action="{{ route('manager.store-project') }}" method="POST" class="new-added-form" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-12 form-group">
                    ...
                    <input value="{{old('code')}}" type="text" placeholder=""
                        class="form-control @error('code') border-red @enderror"
                        name="code">
                    @error('code')
                        <div class="text-red text-xs">
                            {{ $message }}
